...
use SOB\Propel2\Setting;
use SOB\Propel2\SettingQuery;
...
class SettingTableMap extends TableMap
{
	 ...
	 */
	public const CLASS_DEFAULT = 'SOB.Propel2.Setting';

	/**
	 * The (dot-path) name of this class
	 */
	public const CLASS_NAME = 'SOB.Propel2.Map.SettingTableMap';

	/**
	 * the column name for the setting_data field
	 */
	public const COL_SETTING_DATA = 'setting.setting_data';

	/**
	 * the column name for the setting_id field
	 */
	public const COL_SETTING_ID = 'setting.setting_id';
	 ...
	 */
	public const OM_CLASS = '\\SOB\\Propel2\\Setting';
	...
	protected static $fieldKeys = [
		self::TYPE_PHPNAME => ['SettingId' => 0, 'SettingData' => 1, ],
		self::TYPE_CAMELNAME => ['settingId' => 0, 'settingData' => 1, ],
		self::TYPE_COLNAME => [SettingTableMap::COL_SETTING_ID => 0, SettingTableMap::COL_SETTING_DATA => 1, ],
		self::TYPE_FIELDNAME => ['setting_id' => 0, 'setting_data' => 1, ],
		self::TYPE_NUM => [0, 1, ]
	];
	...
	protected static $fieldNames = [
		self::TYPE_PHPNAME => ['SettingId', 'SettingData', ],
		self::TYPE_CAMELNAME => ['settingId', 'settingData', ],
		self::TYPE_COLNAME => [SettingTableMap::COL_SETTING_ID, SettingTableMap::COL_SETTING_DATA, ],
		self::TYPE_FIELDNAME => ['setting_id', 'setting_data', ],
		self::TYPE_NUM => [0, 1, ]
	];
	...
	protected $normalizedColumnNameMap = [
		...
		'settingId' => 'SETTING_ID',
		'setting.settingId' => 'SETTING_ID',
		'SettingTableMap::COL_SETTING_ID' => 'SETTING_ID',
		'COL_SETTING_ID' => 'SETTING_ID',
		'setting_id' => 'SETTING_ID',
		'setting.setting_id' => 'SETTING_ID',
		'SettingData' => 'SETTING_DATA',
		'Setting.SettingData' => 'SETTING_DATA',
		'settingData' => 'SETTING_DATA',
		'setting.settingData' => 'SETTING_DATA',
		'SettingTableMap::COL_SETTING_DATA' => 'SETTING_DATA',
		'COL_SETTING_DATA' => 'SETTING_DATA',
		'setting_data' => 'SETTING_DATA',
		'setting.setting_data' => 'SETTING_DATA',
	];
	...
	{
		if (null === $alias) {
			$criteria->addSelectColumn(SettingTableMap::COL_SETTING_ID);
			$criteria->addSelectColumn(SettingTableMap::COL_SETTING_DATA);
		} else {
			$criteria->addSelectColumn($alias . '.setting_id');
			$criteria->addSelectColumn($alias . '.setting_data');
		}
	}
	 ...
	 */
	 public static function doDelete($values, ?ConnectionInterface $con = null) : int
	 {
		...
		if ($values instanceof Criteria) {
			// rename for clarity
			$criteria = $values;
		} elseif ($values instanceof \SOB\Propel2\Setting) { // it's a model object
			// create criteria based on pk values
			$criteria = $values->buildPkeyCriteria();
		} else { // it's a primary key, or an array of pks
			$criteria = new Criteria(SettingTableMap::DATABASE_NAME);
			$criteria->add(SettingTableMap::COL_SETTING_ID, (array)$values, Criteria::IN);
		}
	...
	public static function doInsert($criteria, ?ConnectionInterface $con = null)
	{
		...
		if ($criteria->containsKey(SettingTableMap::COL_SETTING_ID) && $criteria->keyContainsValue(SettingTableMap::COL_SETTING_ID) ) {
			throw new PropelException('Cannot insert a value for auto-increment primary key (' . SettingTableMap::COL_SETTING_ID . ')');
		}
	...
	public static function getPrimaryKeyHashFromRow(array $row, int $offset = 0, string $indexType = TableMap::TYPE_NUM) : ?string
	{
		...
		if (null === $row[TableMap::TYPE_NUM == $indexType ? 0 + $offset : static::translateFieldName('SettingId', TableMap::TYPE_PHPNAME, $indexType)]) {
			return null;
		}
	...
	public function initialize() : void
	{
		...
		$this->setClassName('\\SOB\\Propel2\\Setting');
		$this->setPackage('SOB.Propel2');
		$this->setUseIdGenerator(true);
		// columns
		$this->addPrimaryKey('setting_id', 'SettingId', 'INTEGER', true, null, null);
		$this->addColumn('setting_data', 'SettingData', 'VARCHAR', false, 255, null);
	}
	...
	{
		if (null === $alias) {
			$criteria->removeSelectColumn(SettingTableMap::COL_SETTING_ID);
			$criteria->removeSelectColumn(SettingTableMap::COL_SETTING_DATA);
		} else {
			$criteria->removeSelectColumn($alias . '.setting_id');
			$criteria->removeSelectColumn($alias . '.setting_data');
		}
	}
}

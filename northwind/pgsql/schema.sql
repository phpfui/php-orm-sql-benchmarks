ALTER TABLE if exists employee_privilege DROP CONSTRAINT if exists fk_employee_privileges_employees1 CASCADE;
ALTER TABLE if exists employee_privilege DROP CONSTRAINT if exists fk_employee_privileges_privileges1 CASCADE;
ALTER TABLE if exists "order" DROP CONSTRAINT if exists fk_order_customers CASCADE;
ALTER TABLE if exists "order" DROP CONSTRAINT if exists fk_order_employee1 CASCADE;
ALTER TABLE if exists "order" DROP CONSTRAINT if exists fk_order_shipper1 CASCADE;
ALTER TABLE if exists "order" DROP CONSTRAINT if exists fk_order_order_tax_status1 CASCADE;
ALTER TABLE if exists "order" DROP CONSTRAINT if exists fk_order_order_status1 CASCADE;
ALTER TABLE if exists product_supplier DROP CONSTRAINT if exists fk_product_supplier_product CASCADE;
ALTER TABLE if exists product_supplier DROP CONSTRAINT if exists fk_product_supplier_supplier CASCADE;
ALTER TABLE if exists purchase_order DROP CONSTRAINT if exists fk_purchase_order_employees1 CASCADE;
ALTER TABLE if exists purchase_order DROP CONSTRAINT if exists fk_purchase_order_purchase_order_status1 CASCADE;
ALTER TABLE if exists purchase_order DROP CONSTRAINT if exists fk_purchase_order_suppliers1 CASCADE;
ALTER TABLE if exists inventory_transaction DROP CONSTRAINT if exists fk_inventory_transactions_order1 CASCADE;
ALTER TABLE if exists inventory_transaction DROP CONSTRAINT if exists fk_inventory_transactions_products1 CASCADE;
ALTER TABLE if exists inventory_transaction DROP CONSTRAINT if exists fk_inventory_transactions_purchase_order1 CASCADE;
ALTER TABLE if exists inventory_transaction DROP CONSTRAINT if exists fk_inventory_transactions_inventory_transaction_type1 CASCADE;
ALTER TABLE if exists invoice DROP CONSTRAINT if exists fk_invoices_order1 CASCADE;
ALTER TABLE if exists order_detail DROP CONSTRAINT if exists fk_order_details_order1 CASCADE;
ALTER TABLE if exists order_detail DROP CONSTRAINT if exists fk_order_details_product1 CASCADE;
ALTER TABLE if exists order_detail DROP CONSTRAINT if exists fk_order_details_order_detail_status1 CASCADE;
ALTER TABLE if exists purchase_order_detail DROP CONSTRAINT if exists fk_purchase_order_details_inventory_transactions1 CASCADE;
ALTER TABLE if exists purchase_order_detail DROP CONSTRAINT if exists fk_purchase_order_details_products1 CASCADE;
ALTER TABLE if exists purchase_order_detail DROP CONSTRAINT if exists fk_purchase_order_details_purchase_order1 CASCADE;
--------------------------------------------------------
-- Table "customer"
--------------------------------------------------------
...
CREATE TABLE IF NOT EXISTS "customer" (
  ...
  "attachments" BYTEA NULL DEFAULT NULL);
...
CREATE TABLE IF NOT EXISTS "order" (
  ...
  "shipped_date" TIMESTAMPTZ NULL DEFAULT NULL,
...
CREATE INDEX "order_tax_status_id" ON "order" ("order_tax_status_id");
...
CREATE TABLE IF NOT EXISTS "purchase_order" (
  ...
  "expected_date" TIMESTAMPTZ NULL DEFAULT NULL,
...
CREATE TABLE IF NOT EXISTS "inventory_transaction" (
  "inventory_transaction_id" SERIAL NOT NULL PRIMARY KEY,
  "inventory_transaction_type_id" INTEGER NOT NULL,
  "transaction_created_date" TIMESTAMPTZ NOT NULL DEFAULT CURRENT_TIMESTAMP,
  "transaction_modified_date" TIMESTAMPTZ NOT NULL DEFAULT CURRENT_TIMESTAMP,
  "product_id" INTEGER NOT NULL,
...
CREATE TABLE IF NOT EXISTS "invoice" (
  ...
  "due_date" TIMESTAMPTZ NULL DEFAULT NULL,
...
CREATE TABLE IF NOT EXISTS "order_detail" (
  ...
  "date_allocated" TIMESTAMPTZ NULL DEFAULT NULL,
  "purchase_order_id" INTEGER NULL DEFAULT NULL,
...
CREATE TABLE IF NOT EXISTS "purchase_order_detail" (
  "purchase_order_detail_id" SERIAL NOT NULL PRIMARY KEY,
  "purchase_order_id" INTEGER NOT NULL,
  "product_id" INTEGER NULL DEFAULT NULL,
  "quantity" DECIMAL(18,4) NOT NULL,
  "unit_cost" DECIMAL(19,4) NOT NULL,
  "date_received" TIMESTAMPTZ NULL DEFAULT NULL,

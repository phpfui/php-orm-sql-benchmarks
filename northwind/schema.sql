...
CREATE INDEX `order_tax_status` ON `order` (`order_tax_status_id`);
...
CREATE TABLE IF NOT EXISTS `purchase_order` (
  `purchase_order_id` INTEGER NOT NULL PRIMARY KEY AUTO_INCREMENT,
...
CREATE TABLE IF NOT EXISTS `inventory_transaction` (
  `inventory_transaction_id` INTEGER NOT NULL PRIMARY KEY AUTO_INCREMENT,
...
CREATE TABLE IF NOT EXISTS `order_detail` (
  `order_detail_id` INTEGER NOT NULL PRIMARY KEY AUTO_INCREMENT,
...
CREATE TABLE IF NOT EXISTS `purchase_order_detail` (
  `purchase_order_detail_id` INTEGER NOT NULL PRIMARY KEY AUTO_INCREMENT,

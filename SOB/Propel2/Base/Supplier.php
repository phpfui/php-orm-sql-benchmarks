...
abstract class Supplier implements ActiveRecordInterface
{
	 ...
	 * @var string
	 */
	public const TABLE_MAP = '\\SOB\\Propel2\\Map\\SupplierTableMap';
	...
	/**
	 * Initializes internal state of SOB\Propel2\Base\Supplier object.
	 */
	...
	public function buildCriteria() : Criteria
	{
		...
		if ($this->isColumnModified(SupplierTableMap::COL_COMPANY)) {
			$criteria->add(SupplierTableMap::COL_COMPANY, $this->company);
		}

		if ($this->isColumnModified(SupplierTableMap::COL_LAST_NAME)) {
			$criteria->add(SupplierTableMap::COL_LAST_NAME, $this->last_name);
		}

		if ($this->isColumnModified(SupplierTableMap::COL_FIRST_NAME)) {
			$criteria->add(SupplierTableMap::COL_FIRST_NAME, $this->first_name);
		}

		if ($this->isColumnModified(SupplierTableMap::COL_EMAIL_ADDRESS)) {
			$criteria->add(SupplierTableMap::COL_EMAIL_ADDRESS, $this->email_address);
		}

		if ($this->isColumnModified(SupplierTableMap::COL_JOB_TITLE)) {
			$criteria->add(SupplierTableMap::COL_JOB_TITLE, $this->job_title);
		}

		if ($this->isColumnModified(SupplierTableMap::COL_BUSINESS_PHONE)) {
			$criteria->add(SupplierTableMap::COL_BUSINESS_PHONE, $this->business_phone);
		}

		if ($this->isColumnModified(SupplierTableMap::COL_HOME_PHONE)) {
			$criteria->add(SupplierTableMap::COL_HOME_PHONE, $this->home_phone);
		}

		if ($this->isColumnModified(SupplierTableMap::COL_MOBILE_PHONE)) {
			$criteria->add(SupplierTableMap::COL_MOBILE_PHONE, $this->mobile_phone);
		}

		if ($this->isColumnModified(SupplierTableMap::COL_FAX_NUMBER)) {
			$criteria->add(SupplierTableMap::COL_FAX_NUMBER, $this->fax_number);
		}
		...
		if ($this->isColumnModified(SupplierTableMap::COL_STATE_PROVINCE)) {
			$criteria->add(SupplierTableMap::COL_STATE_PROVINCE, $this->state_province);
		}

		if ($this->isColumnModified(SupplierTableMap::COL_ZIP_POSTAL_CODE)) {
			$criteria->add(SupplierTableMap::COL_ZIP_POSTAL_CODE, $this->zip_postal_code);
		}

		if ($this->isColumnModified(SupplierTableMap::COL_COUNTRY_REGION)) {
			$criteria->add(SupplierTableMap::COL_COUNTRY_REGION, $this->country_region);
		}

		if ($this->isColumnModified(SupplierTableMap::COL_WEB_PAGE)) {
			$criteria->add(SupplierTableMap::COL_WEB_PAGE, $this->web_page);
		}

		if ($this->isColumnModified(SupplierTableMap::COL_NOTES)) {
			$criteria->add(SupplierTableMap::COL_NOTES, $this->notes);
		}

		if ($this->isColumnModified(SupplierTableMap::COL_ATTACHMENTS)) {
			$criteria->add(SupplierTableMap::COL_ATTACHMENTS, $this->attachments);
		}
	 ...
	 * @return \SOB\Propel2\Supplier Clone of current object.
	 */
	 ...
	 * objects.
	 *
	 * @param object $copyObj An object of \SOB\Propel2\Supplier (or compatible) type.
	 * @param bool $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
	...
	public function copyInto(object $copyObj, bool $deepCopy = false, bool $makeNew = true) : void
	{
		...
		if ($makeNew) {
			$copyObj->setNew(true);
			$copyObj->setSupplierId(null); // this is a auto-increment column, so set to default value
		}
	}
	...
	{
		$validPk = null !== $this->getSupplierId();
	...
	public function hydrate(array $row, int $startcol = 0, bool $rehydrate = false, string $indexType = TableMap::TYPE_NUM) : int
	{
		try {
			...
			$col = $row[TableMap::TYPE_NUM == $indexType ? 0 + $startcol : SupplierTableMap::translateFieldName('SupplierId', TableMap::TYPE_PHPNAME, $indexType)];
			$this->supplier_id = (null !== $col) ? (int)$col : null;

			$col = $row[TableMap::TYPE_NUM == $indexType ? 1 + $startcol : SupplierTableMap::translateFieldName('Company', TableMap::TYPE_PHPNAME, $indexType)];
			$this->company = (null !== $col) ? (string)$col : null;

			$col = $row[TableMap::TYPE_NUM == $indexType ? 2 + $startcol : SupplierTableMap::translateFieldName('LastName', TableMap::TYPE_PHPNAME, $indexType)];
			$this->last_name = (null !== $col) ? (string)$col : null;

			$col = $row[TableMap::TYPE_NUM == $indexType ? 3 + $startcol : SupplierTableMap::translateFieldName('FirstName', TableMap::TYPE_PHPNAME, $indexType)];
			$this->first_name = (null !== $col) ? (string)$col : null;

			$col = $row[TableMap::TYPE_NUM == $indexType ? 4 + $startcol : SupplierTableMap::translateFieldName('EmailAddress', TableMap::TYPE_PHPNAME, $indexType)];
			$this->email_address = (null !== $col) ? (string)$col : null;

			$col = $row[TableMap::TYPE_NUM == $indexType ? 5 + $startcol : SupplierTableMap::translateFieldName('JobTitle', TableMap::TYPE_PHPNAME, $indexType)];
			$this->job_title = (null !== $col) ? (string)$col : null;

			$col = $row[TableMap::TYPE_NUM == $indexType ? 6 + $startcol : SupplierTableMap::translateFieldName('BusinessPhone', TableMap::TYPE_PHPNAME, $indexType)];
			$this->business_phone = (null !== $col) ? (string)$col : null;

			$col = $row[TableMap::TYPE_NUM == $indexType ? 7 + $startcol : SupplierTableMap::translateFieldName('HomePhone', TableMap::TYPE_PHPNAME, $indexType)];
			$this->home_phone = (null !== $col) ? (string)$col : null;

			$col = $row[TableMap::TYPE_NUM == $indexType ? 8 + $startcol : SupplierTableMap::translateFieldName('MobilePhone', TableMap::TYPE_PHPNAME, $indexType)];
			$this->mobile_phone = (null !== $col) ? (string)$col : null;

			$col = $row[TableMap::TYPE_NUM == $indexType ? 9 + $startcol : SupplierTableMap::translateFieldName('FaxNumber', TableMap::TYPE_PHPNAME, $indexType)];
			$this->fax_number = (null !== $col) ? (string)$col : null;

			$col = $row[TableMap::TYPE_NUM == $indexType ? 10 + $startcol : SupplierTableMap::translateFieldName('Address', TableMap::TYPE_PHPNAME, $indexType)];
			$this->address = (null !== $col) ? (string)$col : null;

			$col = $row[TableMap::TYPE_NUM == $indexType ? 11 + $startcol : SupplierTableMap::translateFieldName('City', TableMap::TYPE_PHPNAME, $indexType)];
			$this->city = (null !== $col) ? (string)$col : null;

			$col = $row[TableMap::TYPE_NUM == $indexType ? 12 + $startcol : SupplierTableMap::translateFieldName('StateProvince', TableMap::TYPE_PHPNAME, $indexType)];
			$this->state_province = (null !== $col) ? (string)$col : null;

			$col = $row[TableMap::TYPE_NUM == $indexType ? 13 + $startcol : SupplierTableMap::translateFieldName('ZipPostalCode', TableMap::TYPE_PHPNAME, $indexType)];
			$this->zip_postal_code = (null !== $col) ? (string)$col : null;

			$col = $row[TableMap::TYPE_NUM == $indexType ? 14 + $startcol : SupplierTableMap::translateFieldName('CountryRegion', TableMap::TYPE_PHPNAME, $indexType)];
			$this->country_region = (null !== $col) ? (string)$col : null;

			$col = $row[TableMap::TYPE_NUM == $indexType ? 15 + $startcol : SupplierTableMap::translateFieldName('WebPage', TableMap::TYPE_PHPNAME, $indexType)];
			$this->web_page = (null !== $col) ? (string)$col : null;

			$col = $row[TableMap::TYPE_NUM == $indexType ? 16 + $startcol : SupplierTableMap::translateFieldName('Notes', TableMap::TYPE_PHPNAME, $indexType)];
			$this->notes = (null !== $col) ? (string)$col : null;

			$col = $row[TableMap::TYPE_NUM == $indexType ? 17 + $startcol : SupplierTableMap::translateFieldName('Attachments', TableMap::TYPE_PHPNAME, $indexType)];
			...
			return $startcol + 18; // 18 = SupplierTableMap::NUM_HYDRATE_COLUMNS.

		} catch (Exception $e) {
			throw new PropelException(\sprintf('Error populating %s object', '\\SOB\\Propel2\\Supplier'), 0, $e);
		}
	}
	...
	{
		return null === $this->getSupplierId();
	}
	...
	public function setAttachments($v)
	{
		...
		$this->modifiedColumns[SupplierTableMap::COL_ATTACHMENTS] = true;
	...
	public function setBusinessPhone($v)
	{
		...
		if ($this->business_phone !== $v) {
			...
			$this->modifiedColumns[SupplierTableMap::COL_BUSINESS_PHONE] = true;
		}
	...
	public function setCompany($v)
	{
		...
		if ($this->company !== $v) {
			$this->company = $v;
			$this->modifiedColumns[SupplierTableMap::COL_COMPANY] = true;
		}
	...
	public function setCountryRegion($v)
	{
		...
		if ($this->country_region !== $v) {
			...
			$this->modifiedColumns[SupplierTableMap::COL_COUNTRY_REGION] = true;
		}
	...
	public function setEmailAddress($v)
	{
		...
		if ($this->email_address !== $v) {
			...
			$this->modifiedColumns[SupplierTableMap::COL_EMAIL_ADDRESS] = true;
		}
	...
	public function setFaxNumber($v)
	{
		...
		if ($this->fax_number !== $v) {
			$this->fax_number = $v;
			$this->modifiedColumns[SupplierTableMap::COL_FAX_NUMBER] = true;
		}
	...
	public function setFirstName($v)
	{
		...
		if ($this->first_name !== $v) {
			$this->first_name = $v;
			$this->modifiedColumns[SupplierTableMap::COL_FIRST_NAME] = true;
		}
	...
	public function setHomePhone($v)
	{
		...
		if ($this->home_phone !== $v) {
			$this->home_phone = $v;
			$this->modifiedColumns[SupplierTableMap::COL_HOME_PHONE] = true;
		}
	...
	public function setJobTitle($v)
	{
		...
		if ($this->job_title !== $v) {
			$this->job_title = $v;
			$this->modifiedColumns[SupplierTableMap::COL_JOB_TITLE] = true;
		}
	...
	public function setLastName($v)
	{
		...
		if ($this->last_name !== $v) {
			$this->last_name = $v;
			$this->modifiedColumns[SupplierTableMap::COL_LAST_NAME] = true;
		}
	...
	public function setMobilePhone($v)
	{
		...
		if ($this->mobile_phone !== $v) {
			$this->mobile_phone = $v;
			$this->modifiedColumns[SupplierTableMap::COL_MOBILE_PHONE] = true;
		}
	...
	public function setNotes($v)
	{
		...
		if ($this->notes !== $v) {
			$this->notes = $v;
			$this->modifiedColumns[SupplierTableMap::COL_NOTES] = true;
		}
	...
	public function setStateProvince($v)
	{
		...
		if ($this->state_province !== $v) {
			...
			$this->modifiedColumns[SupplierTableMap::COL_STATE_PROVINCE] = true;
		}
	...
	public function setWebPage($v)
	{
		...
		if ($this->web_page !== $v) {
			$this->web_page = $v;
			$this->modifiedColumns[SupplierTableMap::COL_WEB_PAGE] = true;
		}
	...
	public function setZipPostalCode($v)
	{
		...
		if ($this->zip_postal_code !== $v) {
			...
			$this->modifiedColumns[SupplierTableMap::COL_ZIP_POSTAL_CODE] = true;
		}
